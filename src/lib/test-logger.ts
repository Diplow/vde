...
const formatLog = (type: string, message: string, data?: any): string => {
...
export const testLogger = {
  ...
  interaction: (action: string, target: string, details?: any) => {
    if (isTestEnvironment) {
...
export const logTileInfo = (tileId: string, action: string, details?: any) => {
